...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2017 at 03:42 AM
...
(2, 'EB000001', 'Clement', 'Dsouza', 'clement', 'c5c0c6a2d40f17ffc63e2823858fa629', '630be7b17ecb9502959938d6173357a6', 'Active', '7022208573', 'cmdacds@gmail.com', 'kadri, Manglore', 'DK', 'Karnataka', 'India', '2017-03-07', '2017-03-17 06:22:45', '440646187906ch1.jpg', '532036666937614095460.jpg'),
...
(7, 'EB000001', 'Shivani', 'kY', 'shivani', '7e64454221c345dd330bec94f35521f9', '3ab84b5ff2f96b5a2646c2d35dd5b041', 'Active', '9856472548', 'cmdacds@gmail.com', 'Shivbag, Manglore', 'DK', 'Karnataka', 'India', '2017-03-17', '2017-03-17 08:30:01', '', ''),
...
CREATE TABLE `mail` (
  ...
  `adminst` varchar(10) NOT NULL,
  `custmerst` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `mail` (`mail_request_id`, `sender_id`, `receiver_id`, `subject`, `message`, `message_type`, `date_time`, `adminst`, `custmerst`) VALUES
(15, 2, 1, 'test', '<p>nhhgbfcfxdzcdf</p>', 'CustomerAdmin', '2017-03-07 01:54:06', '', ''),
(17, 2, 1, 'Hello test mail', '<p>Test message</p>', 'CustomerAdmin', '2017-03-07 01:59:06', '', ''),
(20, 2, 1, 'Database Design', '<p>Here is the design part...</p>', 'CustomerAdmin', '2017-03-08 02:54:11', '', ''),
(30, 2, 3, 'database', '<p>test</p>', 'AdminCustomer', '2017-03-10 06:51:55', '', ''),
(32, 2, 1, 'test', '<p>hello</p>', 'CustomerAdmin', '2017-03-10 07:28:12', '', ''),
(33, 2, 1, 'Hello', '<p>text</p>', 'CustomerAdmin', '2017-03-10 07:40:53', '', ''),
...
(36, 5, 7, 'Registration', '<p>Account registered successfully</p>', 'AdminCustomer', '2017-03-17 11:18:10', '', ''),
(37, 5, 7, 'Registration', '<p>Account registered successfully</p>', 'AdminCustomer', '2017-03-17 11:19:21', '', '');
...
(4, 2, 117501000811394, 117501000811394, 9500.00, 15.00, 'fund transfered', 'Credit', '2017-03-07 05:39:25', '2017-03-07 05:39:25', 'Active'),
(5, 2, 0, 117501000811394, 9500.00, 15.00, 'fund transfered', 'Debit', '2017-03-07 05:39:25', '2017-03-07 05:39:25', 'Active'),
...
--
ALTER TABLE `mail`
  MODIFY `mail_request_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT for table `registered_payee`
--
ALTER TABLE `registered_payee`
  MODIFY `registered_payee_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `transaction`
--
ALTER TABLE `transaction`
  MODIFY `trans_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
